...
@Component({
  ...
  template: `
    <div class="card card-block">
      ...
      <div class="card-text">
        <p ngNonBindable>{{ 1234.56 | currency:'CAD': false }}</p>
        <p>{{ 1234.56 | currency:"CAD": false }}</p>
    ...
    <div class="card card-block">
      ...
      <div class="card-text">
        ...
        <p ngNonBindable>{{ dateVal | date: 'H:m:s a d/M/y' }}</p>
        <p>{{ dateVal | date: 'H:m:s a d/M/y' }}</p>
      </div>
    </div>
    ...
    <div class="card card-block">
      <div class="card-text">
        ...
        <p ngNonBindable>{{ 13.1 | number: '1.4-4' }}</p>
        <p>{{ 13.1 | number: '1.4-4' }}</p>
      </div>
    </div>
...
@Component({
  selector: 'app-main',
  template: `
    <app-pipe-builtins></app-pipe-builtins>
  `
})
class AppComponent {
}
